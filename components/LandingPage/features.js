...
const Features = () => {
	...
	const containeBlueTextUp = (
		<>
			<Typography
				variant="h3"
				gutterBottom
				style={{ fontFamily: '"Poppins", Sans-serif', paddingBottom: '25px' }}
			>
			...
			<Typography
				variant="h4"
				gutterBottom
				style={{ fontFamily: '"Poppins", Sans-serif', paddingBottom: '20px' }}
			>
				<span style={{ fontSize: '2.6rem', fontWeight: 600 }}>GuesTodo</span> provides the
	...
	const containeBlueTextDown = (
		<>
			<Typography
				variant="h5"
				gutterBottom
				style={{ fontFamily: '"Poppins", Sans-serif', padding: '0px ​45px 15px 45px' }}
			>
				Whether you are a single property landlord or a property management company,
				<span style={{ fontWeight: 600 }}> GuesTodo </span> integrates smart bookkeeping,
				audits and inventories so that remote management of your income and revenue is
				possible.
			</Typography>
			<Typography
				variant="h5"
	...
	let textContent = [
...

		{
			...
			txt: (
				<>
					<b>Want to have peace of mind?</b>
					<br></br>
					<p></p>
					...
					all transactions made to ensure secured transparency.
				</>
			),
		},

		{
			...
			txt: (
				<>
					...
					<br></br>
					<p></p>
					<b>GuesTodo app</b> equips you with relevant business data. The app specifically
					records overhead expenses including cash-outflow according to each category such
					as maintenance, utilities, fees, supplies and other miscellaneous expenses.
				</>
			),
		},
		{
	...
	let LeftToRight = (x) => (
		<>
			<Grid
				...
				style={sreenSM ? { paddingBottom: '30px' } : {}}
			>
				<Grid item className={classes.ttlFeatures}>
					{x.ttl}
				</Grid>
				<Grid item className={classes.grnLine}></Grid>
			...
			<Grid
				...
				md={6}
				style={
					sreenSM ? { textAlign: 'center' } : { textAlign: 'end', alignSelf: 'center' }
				}
			>
	...
	let RightToLeft = (x) => (
		<>
			<Grid
				...
				md={6}
				style={
					sreenSM ? { textAlign: 'center' } : { textAlign: 'start', alignSelf: 'center' }
				}
			>
				<img src={x.img} alt="Mypicture" width={x.width} />
			</Grid>
			...
			<div style={{ backgroundColor: '#193e6d' }}>
				<Container maxWidth="lg">
					<Grid
						...
						direction="column"
						alignItems="center"
						style={sreenSM ? { padding: '40px 0' } : { padding: '70px 0' }}
						className={classes.cstmText}
					>
				...
				<Container maxWidth="sm" className={classes.tailorMadeDiv}>
					...
					<div style={{ paddingTop: '30px' }}>
						<p style={{ fontSize: '20px' }}>
							Take advantage of GuesTodo’s excellent financial component!
						</p>
					</div>
				</Container>
			</div>
