...
const tableCols = [
            {field: 'LstSave', header: 'Last Created', showcol: false,s:['md','lg', 'xl']},
...
const Table =(props) =>{
	...
	const {vtData, setVtData, selectValue, displayDialog, setDisplayDialog,
