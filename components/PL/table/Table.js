...
const Table =(props) =>{
	...
	const {/*valuePL plData, */setValuePL, setPlData, /*setPanelDatePicker*/ setFilteredData} = useContext(SelectContext);
	...
	return(	
		...
		<Grid container >		
			<DataTable  value={props.currentData/*valuePL.From!=null ? plData.data: []*/}
					...
					//	footerColumnGroup={props.data.data.length>0 ?footerGroup: null }
				>
					{dynamicColumns}
			</DataTable>
		</Grid>
